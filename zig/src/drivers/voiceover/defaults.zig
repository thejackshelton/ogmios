...
pub const PlistKey = struct {
    ...
    /// What ogmios writes during `configureSettings`.
    ogmios_default: PlistValue,
};
...
pub fn keyCatalog() []const PlistKey {
    const catalog = comptime [_]PlistKey{
        .{ .name = "SCREnableAppleScript", .value_type = .boolean, .ogmios_default = .{ .boolean = true } },
        .{ .name = "SCRCategories_SCRCategorySystemWide_SCRSoundComponentSettings_SCRDisableSound", .value_type = .boolean, .ogmios_default = .{ .boolean = true } },
        .{ .name = "SCRCategories_SCRCategoryRotorAndTables_SCRGeneralSettings_SCRRateAsPercent", .value_type = .integer, .ogmios_default = .{ .integer = 90 } },
        .{ .name = "SCRCategories_SCRCategoryActivities_SCRVerbositySettings_SCRVerbosityLevel", .value_type = .integer, .ogmios_default = .{ .integer = 0 } },
        .{ .name = "SCRCategories_SCRCategoryHintsAndTips_SCRHintDelay_SCRShouldSpeakHints", .value_type = .boolean, .ogmios_default = .{ .boolean = false } },
        .{ .name = "SCRCategories_SCRCategoryPunctuationAndSymbols_SCRPunctuationSettings_SCRPunctuationLevel", .value_type = .integer, .ogmios_default = .{ .integer = 0 } },
        .{ .name = "SCRCategories_SCRCategoryVerbosity_SCRShouldSpeakStaticText", .value_type = .boolean, .ogmios_default = .{ .boolean = true } },
        .{ .name = "SCRCategories_SCRCategoryVoices_SCRSpeakChannel", .value_type = .string, .ogmios_default = .{ .string = "com.apple.speech.synthesis.voice.Alex" } },
        .{ .name = "SCRShouldAnnounceKeyCommands", .value_type = .boolean, .ogmios_default = .{ .boolean = false } },
    };
    return &catalog;
}
...
/// Write ogmios's defaults, honoring per-call InitOptions overrides:
