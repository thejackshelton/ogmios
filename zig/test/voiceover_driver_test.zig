...
test "OGMIOS_AX_TARGET_PID env override is honored in startImpl (Phase 7 Plan 04)" {
    // This pins the pid-filter wiring: when OGMIOS_AX_TARGET_PID is set, the AX
    ...
    _ = env_c.setenv("OGMIOS_AX_TARGET_PID", "99999", 1);
    defer _ = env_c.unsetenv("OGMIOS_AX_TARGET_PID");
