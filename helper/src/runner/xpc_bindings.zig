...
// surface that the Ogmios helper uses.
//
...
/// The Mach service name used by OgmiosRunner. Keep in sync with
/// `helper/Sources/OgmiosRunnerProtocol/OgmiosRunnerProtocol.swift`
/// (`OgmiosRunnerMachServiceName`).
pub const mach_service_name: [*:0]const u8 = "org.ogmios.runner";
...
pub extern "c" fn ogmios_xpc_install_event_handler_block(
    connection: xpc_connection_t,
    handler: xpc_event_handler_fn,
) void;
...
pub extern "c" fn ogmios_xpc_install_peer_message_handler_block(
    connection: xpc_connection_t,
    handler: xpc_event_handler_fn,
) void;
...
pub extern "c" fn ogmios_xpc_self_test_invoke_handler_block(
    handler: xpc_event_handler_fn,
    arg: xpc_object_t,
) void;
