...
//
// The pre-built `shoki/matchers` type augmentation in
...
// the augmentation shipped with `shoki/matchers` — which was built
// against Vitest 3 — does not always merge cleanly into the Vitest-4 graph
// when both versions coexist in the monorepo (the main `shoki` package stays
