// Packer template for the shoki VO-ready macOS Sonoma (14) image.
//
// Produces: ghcr.io/shoki/macos-vo-ready:sonoma (slim, ~<15 GB)
// Optional: ghcr.io/shoki/macos-vo-ready:sonoma@full (Xcode + iOS sims, ~50 GB)
//
// Build locally:
...
//   tart push ghcr.io/shoki/macos-vo-ready:sonoma --shallow
...
build {
  ...
  // Final health probe. This is the canary that Phase 5 images boot with shoki doctor ready.
  provisioner "shell" {
    inline = [
